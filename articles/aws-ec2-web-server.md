...
![ec2-step1](/images/articles/aws-ec2-web-server/ec2-step1.png)

### 2. キーペアのページに移動する

リソースの`キーペア`をクリックします。
![ec2-step2](/images/articles/aws-ec2-web-server/ec2-step2.png)

### 3. キーペアを作成する

画面右上の`キーペアを作成`をクリックします
![ec2-step3](/images/articles/aws-ec2-web-server/ec2-step3.png)
...
3. プライベートキーファイル形式 →`.pem`
   ![ec2-step4](/images/articles/aws-ec2-web-server/ec2-step4.png)
...
自動でダウンロードされる事を確認します。
![ec2-step5](/images/articles/aws-ec2-web-server/ec2-step5.png)
...
![ec2-step6](/images/articles/aws-ec2-web-server/ec2-step6.png)
...
![ec2-step7](/images/articles/aws-ec2-web-server/ec2-step7.png)

### 2. サーバー名を設定する

今回は、`server_for_study`という名前のサーバー名にします
![ec2-step8](/images/articles/aws-ec2-web-server/ec2-step8.png)

### 3. OS を設定する

今回は、`Ubuntu server 22.04`を選択します。
![ec2-step9](/images/articles/aws-ec2-web-server/ec2-step9.png)

### 4. インスタンスを起動するページに移動する

`t2.micro`の無料利用枠を設定します
![ec2-step10](/images/articles/aws-ec2-web-server/ec2-step10.png)

### 5. キーペアの設定する

先ほど作成した`キーペア`を選択します。
![ec2-step11](/images/articles/aws-ec2-web-server/ec2-step11.png)
...
- インターネットからの HTTP トラフィックを許可
  ![ec2-step12](/images/articles/aws-ec2-web-server/ec2-step12.png)

### 7. ストレージの設定する

今回は、勉強の為（料金を抑える為に）なので`8GiB`で設定します。
![ec2-step13](/images/articles/aws-ec2-web-server/ec2-step13.png)
...
![ec2-step14](/images/articles/aws-ec2-web-server/ec2-step14.png)
ロード画面後に`成功`のポップアップが表示があれば OK です！
![ec2-step15](/images/articles/aws-ec2-web-server/ec2-step15.png)

### 2. インスタンスを停止する

料金を発生しないためにサーバーを停止するには、
対象のサーバーにチェックを付け、`インスタンスの状態`をインスタンスを停止"を選択します。
![ec2-step16](/images/articles/aws-ec2-web-server/ec2-step16.png)
ポップアップの停止ボタンをクリックすると、少し時間を経過すると
インスタンスの状態が`停止済み`に変更されます
![ec2-step17](/images/articles/aws-ec2-web-server/ec2-step17.png)
