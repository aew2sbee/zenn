...
IPA の試験問題は、いかに**苦手分野を減らすか**が重要なポイントだと考えています。
普通に問題を解くだけでなく、次につなげるために**間違えた問題**や**分からない単語**をメモしました。

すべての問題を解き直すには時間が足りなくなるため、**必要最小限の問題**を復習するためにスプレッドシートを活用しました。
...
自分は 1 時間も集中することができないため、短い時間に分割して効率良く勉強しました。
